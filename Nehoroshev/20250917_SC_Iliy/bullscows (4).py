...
words_bull = {'one': 'бык', 'few': 'быка', 'many': 'быков'}
words_cow = {'one': 'корова', 'few': 'коровы', 'many': 'коров'}
    ...
    if len(popitka) == 4:  # диа
        for pos in range(4):
            if zagadka[pos] == popitka[pos]:
                ...
                cows += 1
    print(f'{bulls} {word_form(bulls, words_bull)}, {cows} {word_form(cows, words_cow)}')
